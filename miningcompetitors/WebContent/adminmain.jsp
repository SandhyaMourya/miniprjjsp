    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        Matcher m = Pattern.compile(
                "([a-z])([a-z]*)", Pattern.CASE_INSENSITIVE).matcher(admin);
             
             while (m.find()) {
                m.appendReplacement(
                   stringbf, m.group(1).toUpperCase() + m.group(2).toLowerCase());
             }
             admin = m.appendTail(stringbf).toString(); %>
        <h3 align="left" class="style9"> Welcome to <%=admin%></h3>
          <div class="clr"></div>
          <div class="img">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><strong><a href="a_addhotel.jsp">Add Hotels</a> </strong></li>
            <li><strong><a href="a_addmalldetails.jsp">Add Malls</a> </strong></li>
            <li><strong><a href="allhotels.jsp">View All Hotels Based on Competitors</a></strong></li>
            <li><strong><a href="allmalls.jsp">View All Malls Based on Competitors </a></strong></li>
            <li><strong><a href="a_hotelbookingdetails.jsp">View Hotel Booking Details</a> </strong></li>
            <li><strong><a href="a_hotel_mall_results.jsp">View Hotels And Malls Competitors Results</a></strong></li>
            <li><strong><a href="a_topkeywords_results.jsp">View Top K Competitors Results Chart </a> </strong></li>
