...
try 
{
	...
	<h3> <span class="style19">Hotel Name :</span> <span class="style18"><%=hname%>, <%=area%>.</span></h3>
	
	<%
	String sql3="select rank,dfrom,distance from hotels where id='"+id+"'";
	...
	if ( rs.next() )
	{
		...
		s5=rs.getString(8);
            ...
            <tr>
				<th width="167" ><div align="left" class="">Total Number Of Rooms : </div></th>
                <td  width="209" height="33" align="center" valign="middle" ><span class="style5">
                <%out.println(s1);%></span></td>
			</tr>
			<tr>
				<th width="167" ><div align="left" class="">Number Of Rooms Aviable : </div></th>
                <td  width="209" height="33" align="center" valign="middle" ><span class="style5">
                <%out.println(s5);%></span></td>
			</tr>
			<tr>
				<th ><div align="left" class="">Room Price : </div></th>
                <td width="209" height="33" align="center" valign="middle"><span class="style5">
                Rs.<%out.println(s2);%></span></td>
			</tr>
			<tr>
				<th ><div align="left" class="">Distance from : </div></th>
			 <td  width="209" height="33" align="center" valign="middle"><span class="style5">
			   <%out.println(s4);%> (<%out.println(distance);%> Kms)</span></td>
			</tr>
			<tr>
             	<th ><div align="left" class="">Rank : </div></th>
			   	<td  width="209" height="33" align="center" valign="middle"><span class="style5">
		   	    <%out.println(rank);%></span></td>
			  </tr>
			<tr>
             	<th ><div align="left" class="">Phone Number : </div></th>
			   	<td  width="209" height="33" align="center" valign="middle"><span class="style5">
	...
	<%}
		...
		while(rs1.next())
		{
			...
			%>
				...
				<tr>
					<th width="70" height="29" ><span class="">Item</span></th>
					<th width="73" ><span class="">Food Type</span></th>
					<th width="81" ><span class="">Item Name</span></th>
					<th width="139" ><span class="">Item Description</span></th>
					<th width="38" ><span class="">Price</span></th>
				</tr>
			<%
			}m=1;
			%>
		...
		while(rs2.next())
		{
			...
			%>
				<tr>
					<th height="32" colspan="3"><span class="style13">Reviews</span></th>
				</tr>
				<tr style="border:1px solid black;">
					<th width="129" height="29" ><span class="">Username</span></th>
					<th width="132" ><span class="">Review Details </span></th>
					<th width="183" ><span class="">Date</span></th>
				</tr>
			<%
			}n=1;
			%>
	...
	catch(Exception e)
	{
		out.println(e.getMessage());
            ...
            <p align="right">&nbsp;</p>
          <p align="right" class="style12"><a href="allhotels.jsp">Back</a> </p>
          <div class="clr"></div>
        </div>
