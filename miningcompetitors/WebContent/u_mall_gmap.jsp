  ...
  <%@ include file="connect.jsp" %>
  	<%
		...
		try
		{
			...
			String sql1="select location from malls where mallname='"+mname+"'";
    ...
    <div id="container" class="shadow">
        ...
        <div id="sidebar">
            <div class="row" style="background:#E3EDFA">
                ...
                <input type="text" id="txtAddress2" class="text" value="<%=mname%>,<%=s2%>" />
		...
		<p>&nbsp;</p>
		<p align="right"><a href="u_viewmalldetails.jsp?id=<%=id%>&type=<%=type%>&mname=<%=mname%>&key=<%=key%>">Back</a></p>
    </div>
	<%
	}
	catch(Exception e)
