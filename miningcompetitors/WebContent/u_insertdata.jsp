...
<%
					...
					try {
					   ...
					   {
							PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,dob,gender,address,pincode,status,image,Location) values(?,?,?,?,?,?,?,?,?,?,?)");
